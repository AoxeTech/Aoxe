...
{
    private async Task TextFormatterAsync(ITextSerializer textSerializer, string mediaType)
    {
        var dtos = GetDtos();
    ...
    private async Task TextFormatterNullAsync(ITextSerializer textSerializer, string mediaType)
    {
        var httpRequestMessage = CreateHttpRequestMessage(
