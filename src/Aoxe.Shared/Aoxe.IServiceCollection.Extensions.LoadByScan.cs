...
public static partial class AoxeIServiceCollectionExtensions
{
    ...
    public static IServiceCollection FromAssemblyOf<T0, T1, T2, T3>(
    ...
    public static IServiceCollection FromAssemblyOf<T0, T1, T2, T3, T4>(
        this IServiceCollection services
    )
    {
    ...
    public static IServiceCollection FromAssemblyOf<T0, T1, T2, T3, T4, T5>(
        this IServiceCollection services
    )
    {
    ...
    public static IServiceCollection FromAssemblyOf<T0, T1, T2, T3, T4, T5, T6>(
        this IServiceCollection services
    )
    {
    ...
    public static IServiceCollection FromAssemblyOf(
        this IServiceCollection services,
        params Type[] types
    )
    {
